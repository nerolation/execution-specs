...
def apply_body(
    ...
    block_env.state_tracer = StateChangeTracker(block_output.block_access_list_builder)

    # Set system transaction index for pre-execution system contracts
    # EIP-7928: System contracts use block_access_index 0
    set_transaction_index(block_env.state_tracer, 0)
    ...
    for i, tx in enumerate(map(decode_transaction, transactions)):
        set_transaction_index(block_env.state_tracer, i + 1)
        process_transaction(
    ...
    set_transaction_index(block_env.state_tracer, post_execution_index)
...
def process_transaction(
    ...
    increment_nonce(block_env.state, sender, block_env.state_tracer)
...
def process_withdrawals(
    ...
    for i, wd in enumerate(withdrawals):
        ...
        track_balance_change(block_env.state_tracer, wd.address, U256(new_balance))
