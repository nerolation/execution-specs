...
TARGET_BLOB_GAS_PER_BLOCK = U64(393216)  # Halved for 6-second slots (was 786432)
BLOB_BASE_COST = Uint(2**13)
BLOB_SCHEDULE_MAX = U64(4)  # Halved for 6-second slots (was 9)
BLOB_SCHEDULE_TARGET = U64(3)  # Halved for 6-second slots (was 6)
GAS_PER_BLOB = U64(2**17)
MIN_BLOB_GASPRICE = Uint(1)
BLOB_BASE_FEE_UPDATE_FRACTION = Uint(10015432)  # Doubled for 6-second slots (was 5007716)
